# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/02_query.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/02_query.ipynb 5
from . import config
from .core import get_cf_options, prc_get_cf_fields
import pandas as pd

# %% ../nbs/02_query.ipynb 6
def _check_key(key):
    """
