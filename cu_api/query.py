# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/query.ipynb.

# %% auto 0
__all__ = ['Query']

# %% ../nbs/API/query.ipynb 3
from . import config
